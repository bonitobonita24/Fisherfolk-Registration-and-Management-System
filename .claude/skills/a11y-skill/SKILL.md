---
name: a11y-skill
description: Run WCAG 2.1 AA accessibility audits using axe-core (runtime) and eslint-plugin-jsx-a11y (static). Trigger on accessibility scan, a11y audit, or WCAG compliance requests.
---
