...
> - 🟡 **FIS-35** Calendar-of-Activities home → `PLAN_calendar_activities_dashboard.md` (BUILD STARTED 2026-09-05, decisions locked in DECISIONS_LOG; branch `feat/fis35-calendar-activities`; Module 1 schema in progress). Home=Calendar, heatmap→/insights; announce=admins+encoder+bantay_dagat.
