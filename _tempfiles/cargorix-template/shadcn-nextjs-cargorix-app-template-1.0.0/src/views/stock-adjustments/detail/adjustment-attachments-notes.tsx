...
type AdjustmentAttachmentsNotesProps = {
  a: StockAdjustment
}

const AdjustmentAttachmentsNotes = ({ a }: AdjustmentAttachmentsNotesProps) => {
  return (
      ...
      <CardContent className='space-y-6 p-4'>
        <div className='space-y-2'>
          ...
          {a.attachments.length === 0 ? (
            <p className='text-muted-foreground text-sm'>No attachments on this adjustment.</p>
          ) : (
            <div className='space-y-2'>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-sm whitespace-pre-line'>{a.notes || 'No notes added.'}</p>
          <p className='text-muted-foreground text-xs'>Added by {a.createdBy}</p>
        </div>
      </CardContent>
    </Card>
  )
...
export default AdjustmentAttachmentsNotes
