...
const ThemeCustomizer = () => {
  ...
  return (
    <Popover>
      <PopoverTrigger render={<Button variant='ghost' size='icon' aria-label='Customize theme' />}>
        <PaletteIcon />
      </PopoverTrigger>

      <PopoverPrimitive.Portal>
        <PopoverPrimitive.Positioner align='end' sideOffset={8} positionMethod='fixed' className='isolate z-50'>
          <PopoverPrimitive.Popup className='bg-popover text-popover-foreground ring-foreground/10 data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 relative z-50 flex max-h-[calc(100vh-10rem)] w-72 origin-(--transform-origin) flex-col gap-6 overflow-y-auto rounded-md px-0 py-3 text-sm shadow-md ring-1 outline-hidden duration-100'>
            ...
            <div className='flex flex-col gap-1 px-3'>
              ...
              >
                ...
                <SelectContent
                  ...
                  className='w-auto max-w-(--available-width) min-w-(--anchor-width) p-1'
                >
