...
function mergeHoverPaint<T extends Record<string, unknown>>(paint: T, hoverPaint: T | undefined): T {
...
function DefaultMarkerIcon() {
  return <div className='relative h-4 w-4 rounded-full border-2 border-white bg-sky-500 shadow-lg' />
}
...
// Colors are hardcoded (not theme tokens) — tuned for a typical light/dark surface.
