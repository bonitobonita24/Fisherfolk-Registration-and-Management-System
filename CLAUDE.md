...
2  CLAUDE.md rules            This file — all 40 rules
...
## THE 40 RULES (compact — full details in .ai_prompt/phases.md, other .ai_prompt/ files, and AI/Master_Prompt.md)
...
> includes step 0b — confirm the planned task does not violate any of the 40 Rules or the L1-L6 security
...
<!-- AIEF:MANAGED START -->
<!-- Auto-generated by scripts/sync-context.sh — do not edit between markers. Everything else is human-owned. Source rev: fda4d52 -->
